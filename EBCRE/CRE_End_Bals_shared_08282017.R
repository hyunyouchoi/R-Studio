...
setwd("C:/Users/ic07949/Desktop/KPMG/Model Development/development code and data/ED_CRE")
...
#base
######
base <- read.csv("macro_base_08282017.csv", header = T)
...
adverse <- read.csv("macro_adverse_08282017.csv", header=T)
...
#severe
########
severe <- read.csv("macro_severe_08282017.csv", header=T)
