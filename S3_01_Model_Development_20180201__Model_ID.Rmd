---
title: "S3_01_Model_Development_20180201_NOOCRE_Panel_M8"
author: "Ming Xie"
...
requirements <- c("lattice","speedglm","data.table","ggplot2","knitr","gsubfn","zoo","sqldf","latticeExtra","sandwich","QuantPsyc","gridExtra","DT","urca","tseries","car",'ellipse','ResourceSelection','tidyr','snow','parallel','dplyr','panelAR','openxlsx',"moments",'lmtest')
...
setwd("C:\\Users\\kdoughan\\Documents\\01_Engagements\\Bank of Hope\\10_2017_Bank of Hope Commerial Model Build\\2 - Code\\Deliverable")
...
frm<-paste('NCOR',ifelse(rhs=='','1',rhs),sep='~')
  ...
  p.hist<-histogram(~ fit.final$residuals , breaks=16 ,type = "density",xlab='',
      panel=function(x, ...) {
        panel.histogram(x, ...)
  ...
  p.qq<-qqmath(~ fit.final$residuals,xlab='qnorm',ylab='residuals',
...
p.res<-xyplot(residual~Date,data3.hist[ENTITY_NAME=='Bank of Hope'],xlab='',type=c('g','l','p'))
...
fit.autotest<-do.call('rbind',lapply(data3.hist[,unique(ENTITY_NAME),],function(x){
  ...
  tmp0[,residual.adj:=residual,]
  tmp0[,order:=rank(-abs(residual)),]
  tmp0[order%in%c(1,2),residual.adj:=0,]

  
  tmp0.result1<-tmp0[,dwtest(residual~1),]
  tmp0.result2.bg1<-tmp0[,bgtest(residual~1,order=4),]
  tmp0.result2.bg2<-tmp0[,bgtest(residual~1,order=8),]
  tmp0.result3.1<-tmp0[,Box.test (residual, lag = 1, type = "Ljung"),]
  tmp0.result3.2<-tmp0[,Box.test (residual, lag = 2, type = "Ljung"),]
  tmp0.result3.3<-tmp0[,Box.test (residual, lag = 3, type = "Ljung"),]
  tmp0.result3.4<-tmp0[,Box.test (residual, lag = 4, type = "Ljung"),]
  tmp0.result3.5<-tmp0[,Box.test (residual, lag = 5, type = "Ljung"),]
  tmp0.result3.6<-tmp0[,Box.test (residual, lag = 6, type = "Ljung"),]
  tmp0.result3.7<-tmp0[,Box.test (residual, lag = 7, type = "Ljung"),]
  tmp0.result3.8<-tmp0[,Box.test (residual, lag = 8, type = "Ljung"),]
  
  
  tmp0.result2a.bg1<-tmp0[,bgtest(residual.adj~1,order=4),]
  tmp0.result2a.bg2<-tmp0[,bgtest(residual.adj~1,order=8),]
  tmp0.result3a.4<-tmp0[,Box.test (residual.adj, lag = 4, type = "Ljung"),]
  tmp0.result3a.8<-tmp0[,Box.test (residual.adj, lag = 8, type = "Ljung"),]
  
  
  tmp0.result4.adf<-tmp0[,adf.test(residual),]
  tmp0.result4.pp1<-tmp0[,pp.test(residual,type=c("Z(alpha)")),]
  tmp0.result4.pp2<-tmp0[,pp.test(residual,type=c("Z(t_alpha)")),]
  tmp0.result4.kpss1<-tmp0[,kpss.test(residual,null=c("Level")),]
  tmp0.result4.kpss2<-tmp0[,kpss.test(residual,null=c("Trend")),]
  
  tmp0.result4.adf.resp<-tmp0[,adf.test(NCOR),]
  tmp0.result4.pp1.resp<-tmp0[,pp.test(NCOR,type=c("Z(alpha)")),]
  tmp0.result4.pp2.resp<-tmp0[,pp.test(NCOR,type=c("Z(t_alpha)")),]
  tmp0.result4.kpss1.resp<-tmp0[,kpss.test(NCOR,null=c("Level")),]
  tmp0.result4.kpss2.resp<-tmp0[,kpss.test(NCOR,null=c("Trend")),]
  # tmp0.result3<-tmp0[,bptest(NCOR~y),]
  # tmp0.result3.1$p.value
  
  tmp1<-rbind(
    data.table(ENTITY_NAME=x,Test='DW Test'
               ,Null.Hypothesis='Errors are serially uncorrelated (lag 1)'
               ,p.value=tmp0.result1$p.value
               )
      ,data.table(ENTITY_NAME=x,Test='BG Test'
               ,Null.Hypothesis='No serial correlation of any order up to 4'
               ,p.value=tmp0.result2.bg1$p.value
               )
      ,data.table(ENTITY_NAME=x,Test='BG Test'
               ,Null.Hypothesis='No serial correlation of any order up to 8'
               ,p.value=tmp0.result2.bg2$p.value
               )
      ,data.table(ENTITY_NAME=x,Test='BG Test (Remove 2 Outliers)'
               ,Null.Hypothesis='No serial correlation of any order up to 4'
               ,p.value=tmp0.result2a.bg1$p.value
               )
      ,data.table(ENTITY_NAME=x,Test='BG Test (Remove 2 Outliers)'
               ,Null.Hypothesis='No serial correlation of any order up to 8'
               ,p.value=tmp0.result2a.bg2$p.value
               )
    
      ,data.table(ENTITY_NAME=x,Test='Ljung Test'
               ,Null.Hypothesis='Autocorrelations up to lag 1 equal zero'
               ,p.value=tmp0.result3.1$p.value
               )    
      ,data.table(ENTITY_NAME=x,Test='Ljung Test'
               ,Null.Hypothesis='Autocorrelations up to lag 2 equal zero'
               ,p.value=tmp0.result3.2$p.value
               )        
      ,data.table(ENTITY_NAME=x,Test='Ljung Test'
               ,Null.Hypothesis='Autocorrelations up to lag 3 equal zero'
               ,p.value=tmp0.result3.3$p.value
               )   
      ,data.table(ENTITY_NAME=x,Test='Ljung Test'
               ,Null.Hypothesis='Autocorrelations up to lag 4 equal zero'
               ,p.value=tmp0.result3.4$p.value
               )
      ,data.table(ENTITY_NAME=x,Test='Ljung Test (Remove 2 Outliers)'
               ,Null.Hypothesis='Autocorrelations up to lag 4 equal zero'
               ,p.value=tmp0.result3a.4$p.value
           )
      ,data.table(ENTITY_NAME=x,Test='Ljung Test'
               ,Null.Hypothesis='Autocorrelations up to lag 5 equal zero'
               ,p.value=tmp0.result3.5$p.value
               )    
      ,data.table(ENTITY_NAME=x,Test='Ljung Test'
               ,Null.Hypothesis='Autocorrelations up to lag 6 equal zero'
               ,p.value=tmp0.result3.6$p.value
               )        
      ,data.table(ENTITY_NAME=x,Test='Ljung Test'
               ,Null.Hypothesis='Autocorrelations up to lag 7 equal zero'
               ,p.value=tmp0.result3.7$p.value
               )   
      ,data.table(ENTITY_NAME=x,Test='Ljung Test'
               ,Null.Hypothesis='Autocorrelations up to lag 8 equal zero'
               ,p.value=tmp0.result3.8$p.value
               )
      ,data.table(ENTITY_NAME=x,Test='Ljung Test (Remove 2 Outliers)'
               ,Null.Hypothesis='Autocorrelations up to lag 8 equal zero'
               ,p.value=tmp0.result3a.8$p.value
               )
    
    
    
      ,data.table(ENTITY_NAME=x,Test='ADF Test'
               ,Null.Hypothesis='A Unit Root is presented'
               ,p.value=tmp0.result4.adf$p.value
               )
      ,data.table(ENTITY_NAME=x,Test='PP Test (Level)'
               ,Null.Hypothesis='A Unit Root is presented'
               ,p.value=tmp0.result4.pp1$p.value
               )
      ,data.table(ENTITY_NAME=x,Test='PP Test (Trend)'
               ,Null.Hypothesis='A Unit Root is presented'
               ,p.value=tmp0.result4.pp2$p.value
               )

      ,data.table(ENTITY_NAME=x,Test='KPSS Test (Level)'
               ,Null.Hypothesis='The sereis is level stationary'
               ,p.value=tmp0.result4.kpss1$p.value
               )
      ,data.table(ENTITY_NAME=x,Test='KPSS Test (Trend)'
               ,Null.Hypothesis='The sereis is trend stationary'
               ,p.value=tmp0.result4.kpss2$p.value
               )

    
      ,data.table(ENTITY_NAME=x,Test='ADF Test (NCOR)'
               ,Null.Hypothesis='A Unit Root is presented'
               ,p.value=tmp0.result4.adf.resp$p.value
               )
      ,data.table(ENTITY_NAME=x,Test='PP Test (NCOR Level)'
               ,Null.Hypothesis='A Unit Root is presented'
               ,p.value=tmp0.result4.pp1.resp$p.value
               )
      ,data.table(ENTITY_NAME=x,Test='PP Test (NCOR Trend)'
               ,Null.Hypothesis='A Unit Root is presented'
               ,p.value=tmp0.result4.pp2.resp$p.value
               )

      ,data.table(ENTITY_NAME=x,Test='KPSS Test (NCOR Level)'
               ,Null.Hypothesis='The sereis is level stationary'
               ,p.value=tmp0.result4.kpss1.resp$p.value
               )
      ,data.table(ENTITY_NAME=x,Test='KPSS Test (NCOR Trend)'
               ,Null.Hypothesis='The sereis is trend stationary'
               ,p.value=tmp0.result4.kpss2.resp$p.value
               )   
...
print(fit.autotest,nrow=nrow(fit.autotest))

print(p.res)
print(p.hist, split = c(1, 1, 2, 1), more = TRUE)
print(p.qq, split = c(2, 1, 2, 1), more = FALSE)

par(mfrow=c(1,2));

acf(data3.hist[ENTITY_NAME=='Bank of Hope',,]$residual,main='',xlab='');
pacf(data3.hist[ENTITY_NAME=='Bank of Hope',,]$residual,main='',xlab='');
par(mfrow=c(1,1));
...
## 3.8 Chow's Test For Slope Similarity

This chapter only applys to models that incorporate peer banks data. This test try to find whether the $l^{th}$ macro variable might have different effect on different peer banks.

$$H_0: y\sim \alpha_i + \sum \beta_k\cdot mev_k$$
$$H_a: y\sim \alpha_i + \sum_{-l} \beta_k\cdot mev_k+\beta_{l,i}\cdot mev_{l}$$

```{r,eval=TRUE, echo=FALSE, include=TRUE, warning=FALSE,fig.width=11,fig.height=6}

if(any(grepl('ENTITY_NAME',all.vars(as.formula(frm))))){
  


  test.mev<-setdiff(all.vars(as.formula(frm)),c('NCOR','ENTITY_NAME'))
  test.result<-lapply(test.mev,function(x){
    # x='empl_qg_EWMA2_lag3'
    frm.alt<-update(update(as.formula(frm),paste('~.-',x,sep='')),paste('~.+ENTITY_NAME:',x,sep=''))
    fit.alt<-lm(frm.alt,data3.hist)
    
    cat('\n==========================================\n')
    cat('\nTesting Individial Interactions with MEV:',x,'\n')
    cat('\n==========================================\n')
    print(summary(fit.final))
    print(summary(fit.alt))
    tmp<-anova(fit.final,fit.alt)
    print(tmp)
    return(tmp)
  })
  
  cat('\n\n')
  # names(test.result)<-test.mev
  # print(test.result)
  
  frm.alt.all<-update(update(as.formula(frm)
                         ,paste('~.-',paste(test.mev,sep='',collapse = '-'),sep=''))
                  ,paste('~.+',paste('ENTITY_NAME:',test.mev,sep='',collapse = '+'),sep=''))
  fit.alt.all<-lm(frm.alt.all,data3.hist)
  tmp<-anova(fit.final,fit.alt.all)
  
  cat('\n==========================================\n')
  cat('\nTesting All Interactions with MEVs (BOH with All Peer Banks) \n')
  cat('\n==========================================\n')
  
  print(tmp)
  
  
  test.result<-lapply(setdiff(data3.hist[,unique(ENTITY_NAME),],'Bank of Hope'),function(x){
    #x='PacWest Bancorp'
  tmp.dt<-data3.hist[ENTITY_NAME%in%c('Bank of Hope',x),]
  frm.alt.pair1<-update(update(as.formula(frm)
                         ,paste('~.-',paste(test.mev,sep='',collapse = '-'),sep=''))
                  ,paste('~.+',paste('ENTITY_NAME:',test.mev,sep='',collapse = '+'),sep=''))
  fit.alt.pair0<-lm(frm,tmp.dt)
  fit.alt.pair1<-lm(frm.alt.pair1,tmp.dt)
  tmp<-anova(fit.alt.pair0,fit.alt.pair1)
  
  cat('\n==========================================\n')
  cat('\nTesting All Interactions with MEVs ( for BOH and',x,') \n')
  cat('\n==========================================\n')
